...
This project implements a comprehensive Enterprise Resource Planning (ERP) system inspired by Oracle's functionalities. It is built using Java and JDBC to interact with a relational database (e.g., PostgreSQL, MySQL). The system provides modules for managing various aspects of a business, including Finance, Supply Chain, Manufacturing, Customer Relationship, and Human Capital.
